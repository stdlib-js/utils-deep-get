...
```javascript
import deepGet from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-deep-get@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-deep-get@v0.2.2-deno/mod.js';
```
